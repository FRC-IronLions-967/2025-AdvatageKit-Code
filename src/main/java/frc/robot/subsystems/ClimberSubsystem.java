...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public ClimberSubsystem() {
    ...
    climberMotorConfig.smartCurrentLimit(40).idleMode(IdleMode.kBrake);
    climberMotorConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(1, 0, 0);
  ...
  /**
   * moves the climber arm IMPORTANT: This method is defferent than runClimberArm! This runs the
   * climber based off position.
   *
  ...
  /**
   * moves the climber arm IMPORTANT: This method is different than moveClimberArm! This runs the
   * climber based off speed.
   *
   * @param speed
   */
  ...
  public boolean isClimberInPosition(double setPosition) {
    return setPosition - Constants.climberTolerance < getClimbPosition()
        && getClimbPosition() < setPosition + Constants.climberTolerance;
  }
